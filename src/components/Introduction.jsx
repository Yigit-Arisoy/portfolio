  ...
  return (
    <div>
      ...
      <video
        ...
        autoPlay
        loop
        className="sm:hidden absolute top-96 left-0 z-0 opacity-50"
      ></video>
      <video
        src={require("../media/bgVideo.mp4")}
        autoPlay
        loop
        className="sm:hidden absolute bottom-0 left-0 z-0 opacity-50"
      ></video>
      <div className="mt-48 h-[75vh] mx-16">
        ...
        <div className="text-left text-neutral text-xl font-semibold w-96">
          <Message
            message={
