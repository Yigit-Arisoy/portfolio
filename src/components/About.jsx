...
function About() {
  return (
    <div className="h-[110vh] sm:h-[75vh] bg-bgSecond sm:pt-16">
      <h1 className="text-primary font-bold text-5xl text-center pt-16">
        Who I Am
      </h1>
      <div className="flex flex-col sm:flex-row justify-center mx-12 sm:mx-0 items-center sm:mb-0">
        ...
        <div className="order-1 sm:order-2 ">
          <img
            ...
            alt="qwe"
            className="mt-16 sm:mt-0 rounded-full w-64 shadow-md shadow-primary imageFilter z-20"
          />
        </div>
      </div>
    </div>
